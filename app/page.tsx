        ...
        <div className="bg-[#0b001a] border border-[#ff00ff]/30 rounded-2xl flex flex-col xl:flex-row items-stretch justify-between relative overflow-hidden shadow-[0_0_20px_rgba(255,0,255,0.15)]">
          ...
          <div className="relative py-4 px-10 flex items-center justify-center xl:mr-8 mb-4 xl:mb-0 w-[85%] xl:w-auto mx-auto xl:mx-0">
            ...
            <div className="relative z-10 flex items-center gap-4">
              ...
              <div>
                <div className="font-black text-xl italic text-[#A51BEF] tracking-wide leading-tight">GAME ON.</div>
                <div className="text-[11px] font-black text-[#A51BEF] tracking-wider">AHORRA MÁS.</div>
              </div>
            </div>
          </div>
        </div>
